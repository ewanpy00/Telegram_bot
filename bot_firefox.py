#!/usr/bin/env python3
"""
Альтернативная версия бота с Firefox для macOS
"""
...
async def init_browser():
    """
    Инициализирует браузер Firefox и загружает cookies для авторизации
    """
    ...
    try:
        ...
        # Запускаем Firefox (более стабильный на macOS)
...
async def main():
    ...
    """
    try:
        logger.info("Запуск Telegram бота с Firefox...")
